...
![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.13.1](https://img.shields.io/badge/AppVersion-0.13.1-informational?style=flat-square)

## Verifying the Chart

```shell
# Verify the helm chart
helm secrets template -f argowf/secrets.yaml argowf argowf/
```

## Installing the Chart

To install the chart with the release name `argowf`:

```shell
helm secrets install -f argowf/secrets.yaml argowf argowf/
...
|------------|------|---------|
| https://argoproj.github.io/argo-helm | argo-workflows | 0.13.1 |
